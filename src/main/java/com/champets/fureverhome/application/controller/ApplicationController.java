...
//        }
        ...
        switch (applicationDto.getApplicationStatus()) {
            case APPROVED:
                mailService.sendEmail(application.getUser().getEmailAddress(), "Application Approved", "Your application for pet " + applicationDto.getPet().getName() + " is approved.");
                break;
            case REJECTED:
                mailService.sendEmail(application.getUser().getEmailAddress(), "Application Rejected", "Your application for pet " + applicationDto.getPet().getName() + " is rejected.");
                break;
            case RELEASED:
            ...
            case CANCELLED:
                ...
                applicationDto.getPet().setActive(false);
                mailService.sendEmail(application.getUser().getEmailAddress(), "Application Cancelled", "Your application for pet " + applicationDto.getPet().getName() + " is cancelled.");
                break;
        }
